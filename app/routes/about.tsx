  ...
  return (
    <div className="container">
      ...
      <div className="highlight-box animate-fade-in">
        ...
        <p>
          If you're tired of prototypes that go nowhere and vendors who vanish
          after delivery, let's talk. We'll respond quickly with a clear plan.
        </p>
        <div className="cta-group" style={{ marginTop: 'var(--spacing-xl)' }}>
