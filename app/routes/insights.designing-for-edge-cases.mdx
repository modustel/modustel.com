...
export const meta = () => {
  const title = "Designing for Edge Cases in AI & Automation — Modus Tel Labs";
  const description = "How to build robust AI systems and automation workflows that handle the unusual—and why it matters";
  const ogImage = "https://modustel.com/assets/og-modustel.svg";
  const canonicalUrl = "https://modustel.com/insights/designing-for-edge-cases";
  return [
    { title },
    ...
    { property: "og:image:alt", content: "Modus Tel Labs — Edge cases in AI systems" },
    { property: "og:image:width", content: "1200" },
    { property: "og:image:height", content: "630" },
    { property: "og:type", content: "article" },
    { property: "article:published_time", content: "2025-01-14" },
    { property: "article:author", content: "Modus Tel Labs" },
    { name: "twitter:card", content: "summary_large_image" },
    { name: "twitter:title", content: title },
    { name: "twitter:description", content: description },
    { name: "twitter:image", content: ogImage },
    { name: "twitter:image:alt", content: "Modus Tel Labs — Edge cases in AI systems" },
  ];
};
...
export const handle = {
  structuredData: {
    ...
    "@type": "BlogPosting",
    headline: "Designing for Edge Cases in AI & Automation",
    description: "How to build robust AI systems and automation workflows that handle the unusual—and why it matters",
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": "https://modustel.com/insights/designing-for-edge-cases" },
  },
};
